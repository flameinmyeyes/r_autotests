...
public class FUN_02_BP_016_NSI_016_PZ_2_7_2_8 extends HooksTSE_DEMO_28080 {

    private String WAY_TEST = Ways.TSE_DEMO_28080.getWay() + "\\FUN_02\\BP_016\\FUN_02_BP_016_NSI_016_PZ_2_7_2_8\\";

    @Owner(value="Балашов Илья")
    @Description("NSI_016. ПЗ п. 2.7.2. ТК №8 Проверка перевода записи справочника в архив")
    @Link(name="TSE-T2288", url="https://job-jira.otr.ru/secure/Tests.jspa#/testCase/TSE-T2288")
    ...
    @Step("Открыть запись на статусе \"Актуальная\" и нажать на кнопку \"Отправить в архив\"")
    public void step04() {
        CommonFunctions.printStep();
    ...
    @Step("На сообщении выбрать вариант \"Да\"")
    public void step05() {
        CommonFunctions.printStep();
        new MainPage()
        ...
        //Запись переведена в архив
        CommonFunctions.waitForElementDisplayed(By.xpath("//td[@class='z-listcell'][@title='Архивная']"), 30);
    }
