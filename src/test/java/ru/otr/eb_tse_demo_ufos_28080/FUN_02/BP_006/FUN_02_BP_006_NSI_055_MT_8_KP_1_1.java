...
public class FUN_02_BP_006_NSI_055_MT_8_KP_1_1 extends HooksTSE_DEMO_28080 {

    private String WAY_TEST = Ways.TSE_DEMO_28080.getWay() + "\\FUN_02\\BP_006\\FUN_02_BP_006_NSI_055_MT_8_KP_1_1\\";

    @Owner(value="Балашов Илья")
    @Description("NSI_055. МТ 8. КП 1.1. Реализован справочник \"Реестр приостанавливаемых операций\" (в статусе архив)")
    @Link(name="TSE-T3240", url="https://job-jira.otr.ru/secure/Tests.jspa#/testCase/TSE-T3240")
    ...
    private void step01() {
        ...
        //1. Подготовлен XML-запрос, содержащего информацию по экземпляру формуляра/документу. отправлять http://eb-tse-demo-ufos.otr.ru:18080/web-services/documentLifeCycleService_v1_8?wsdl
