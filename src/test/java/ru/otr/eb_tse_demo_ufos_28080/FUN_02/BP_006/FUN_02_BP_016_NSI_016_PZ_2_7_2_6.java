...
public class FUN_02_BP_016_NSI_016_PZ_2_7_2_6 extends HooksTSE_DEMO_28080 {

    private String WAY_TEST = Ways.TSE_DEMO_28080.getWay() + "\\FUN_02\\BP_016\\FUN_02_BP_016_NSI_016_PZ_2_7_2_6\\";
    private String WAY_DOWNLOADS = Ways.DOWNLOADS.getWay();

    @Owner(value="Балашов Илья")
    @Description("NSI_016. ПЗ п. 2.7.2. ТК №6 Проверка печати списка")
    @Link(name="TSE-T2286", url="https://job-jira.otr.ru/secure/Tests.jspa#/testCase/TSE-T2286")
    ...
    @Step("Нажать на кнопку \"Печать списка\"")
    public void step04() {
        CommonFunctions.printStep();
        new MainPage()
                .resetUserSettings()
        ...
        //PrintScroller_28-04-2021 15-57
        ...
        FileFunctions.moveFileToFolder(wayToSourceFile,WAY_TEST + "printScroller_all.xls");

        //Сформирован документ для печати списка актуальных записей
        Assert.assertTrue(new File(WAY_TEST + "printScroller_all.xls").exists());
    }
