...
public class FUN_02_BP_006_NSI_021_PZ_1_3_1 extends HooksTSE_DEMO_28080 {

    public String WAY_TEST = Ways.TSE_DEMO_28080.getWay() + "\\FUN_02\\BP_006\\FUN_02_BP_006_NSI_021_PZ_1_3_1\\";
    ...
    @Description("NSI_021. ПЗ п. 1.3(1). Требования к статусной модели справочника (Актуализация записи справочника)")
    @Link(name="TSE-T3189", url="https://job-jira.otr.ru/secure/Tests.jspa#/testCase/TSE-T3189")
    ...
    private void step03() {
        ...
        //https://job-jira.otr.ru/secure/Tests.jspa#/testCase/TSE-T3186
        CommonFunctions.printStep();
        new MainPage()
                .resetUserSettings()
