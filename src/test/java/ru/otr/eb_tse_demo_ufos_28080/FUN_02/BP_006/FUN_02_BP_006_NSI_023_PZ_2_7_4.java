...
public class FUN_02_BP_006_NSI_023_PZ_2_7_4 extends HooksTSE_DEMO_28080 {
    private String WAY_TEST = Ways.TSE_DEMO_28080.getWay() + "\\FUN_02\\BP_006\\FUN_02_BP_006_NSI_023_PZ_2_7_4\\";

    @Owner(value = "Максимова Диана")
    @Description("NSI_023. ПЗ п. 2.7.4. Требования к СФ. Требования к сортировке спр-ка")
    @Link(name = "TSE-T3207", url = "https://job-jira.otr.ru/secure/Tests.jspa#/testCase/TSE-T3207")
    ...
    @Step("Переход по дереву навигации к справочнику «Причины отклонения документов»")
    private void step02() {
        CommonFunctions.printStep();
    ...
    @Step("Сбросить все пользовательские настройки\n" +
            "Записи отсортированы по реквизиту  «Код», в порядке возрастания")
    private void step03() {
        CommonFunctions.printStep();
        column("Код").assertOrderIsASC();
    }
