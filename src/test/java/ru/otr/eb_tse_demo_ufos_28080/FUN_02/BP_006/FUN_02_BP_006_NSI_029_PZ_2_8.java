...
public class FUN_02_BP_006_NSI_029_PZ_2_8 extends HooksTSE_DEMO_28080 {

    private String WAY_TEST = Ways.TSE_DEMO_28080.getWay() + "\\FUN_02\\BP_006\\FUN_02_BP_006_NSI_029_PZ_2_8\\";
    private String WAY_DOWNLOADS = Ways.DOWNLOADS.getWay();

    @Owner(value="Балашов Илья")
    @Description("NSI_029. ПЗ п. 2.8. Требования к печатной форме спр-ка")
    @Link(name="TSE-T4991", url="https://job-jira.otr.ru/secure/Tests.jspa#/testCase/TSE-T4991")
    ...
    @Step("Открыть дерево навигации: «Управление расходами (казначейское сопровождение)» - «Справочники» - «Символы кассовой отчетности»")
    private void step02() {
        CommonFunctions.printStep();
    ...
    @Step("Выбрать записи справочника  «Символы кассовой отчетности»")
    private void step03() {
        CommonFunctions.printStep();
        new MainPage()
                .resetUserSettings()
    ...
    private void step04() {
        ...
        //Тип документа:	Символы кассовой отчетности
