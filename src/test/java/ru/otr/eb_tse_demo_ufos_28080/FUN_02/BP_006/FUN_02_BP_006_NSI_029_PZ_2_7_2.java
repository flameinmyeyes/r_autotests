...
public class FUN_02_BP_006_NSI_029_PZ_2_7_2 extends HooksTSE_DEMO_28080 {

    private String WAY_TEST = Ways.TSE_DEMO_28080.getWay() + "\\FUN_02\\BP_006\\FUN_02_BP_006_NSI_029_PZ_2_7_2\\";

    @Owner(value="Балашов Илья")
    @Description("NSI_029. ПЗ п. 2.7.2. Требования к СФ. Требования к действиям из списковой форм")
    @Link(name="TSE-T4990", url="https://job-jira.otr.ru/secure/Tests.jspa#/testCase/TSE-T4990")
    ...
    private void step03() {
        ...
        //обновлена СФ справочника  «Символы кассовой отчетности»
    }

    @Step("Выбрать запись справочника  «Символы кассовой отчетности»")
    private void step04() {
        CommonFunctions.printStep();
        new MainPage().clickRowsInList(1);

        //Выбрана запись справочника
    }
