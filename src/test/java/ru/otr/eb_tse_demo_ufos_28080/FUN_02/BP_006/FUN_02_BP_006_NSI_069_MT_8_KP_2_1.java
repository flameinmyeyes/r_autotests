...
public class FUN_02_BP_006_NSI_069_MT_8_KP_2_1 extends HooksTSE_DEMO_28080 {

    private String WAY_TEST = Ways.TSE_DEMO_28080.getWay() + "\\FUN_02\\BP_006\\FUN_02_BP_006_NSI_069_MT_8_KP_2_1\\";

    @Owner(value="Балашов Илья")
    @Description("NSI_069. МТ 8. КП 2.1. Реализован справ-к \"Перечень КБК, допущенных к проведению операций по кас выплатам в период приос-ия операций на ЛС\"")
    @Link(name="TSE-T3667", url="https://job-jira.otr.ru/secure/Tests.jspa#/testCase/TSE-T3667")
