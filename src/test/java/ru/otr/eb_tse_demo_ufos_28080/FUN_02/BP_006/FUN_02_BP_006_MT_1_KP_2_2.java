...
public class FUN_02_BP_006_MT_1_KP_2_2 extends HooksTSE_DEMO_28080 {

    static String docDate;

    /**
     * МТ 1. КП 2(2). Формирование записи в справочнике  "Проекты" согласующим ЦС ФК
     */

    private static  String WAY_TEST = Ways.TSE_DEMO_28080.getWay() + "\\FUN_02\\BP_006\\FUN_02_BP_006_MT_1_KP_2_2\\";

    @Description("МТ 1. КП 2(2). Формирование записи в справочнике  \"Проекты\" согласующим ЦС ФК")
    @Owner(value = "Каверина Марина")
    @Link(name="TSE-T3830", url="https://job-jira.otr.ru/secure/Tests.jspa#/testCase/TSE-T3830")
    ...
    public static void step01() {
        //Авторизоваться в ЛК ЦС Обслуживания ПУР КС на стенде http://eb-tse-demo-ufos.otr.ru:28080
    ...
    public static void step05() {
        ...
        //D разделе колонок у "Уровень бюджета" у колонка "Федеральный" заполнено значением Нет, колонка "Бюджет субъекта " заполнено значением Да, колонка "Муниципальный " заполнено значением Нет

        Assert.assertEquals($x("//*[contains(@class,\"addedDocument\")]//td[3]").getAttribute("title"), "Нет");
        Assert.assertEquals($x("//*[contains(@class,\"addedDocument\")]//td[4]").getAttribute("title"), "Да");
