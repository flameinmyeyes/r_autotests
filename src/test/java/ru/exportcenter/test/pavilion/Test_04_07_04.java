...
public class Test_04_07_04 extends Hooks {
    ...
    public String WAY_TEST = Ways.TEST.getWay() + "/pavilion/Test_04_07_04/";
...
//    public String processID = "вписываем processid вручную";
    ...
    @Description("04 07 04 Подготовить план работ")
    @Link(name = "Test_04_07_04", url = "https://confluence.exportcenter.ru/pages/viewpage.action?pageId=175253433")
