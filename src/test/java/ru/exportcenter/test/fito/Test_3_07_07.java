...
public class Test_3_07_07 extends Hooks {
    ...
    @Description("3.07.07 (Тест контур) Завершение услуги по таймауту при подписании")
    @Link(name = "Test_3_07_07", url = "https://confluence.exportcenter.ru/pages/viewpage.action?pageId=196775127")
