package ru.exportcenter.test.agroexpress.Test_03_07_04_1;
...
public class Test_03_07_04_1_10 extends Hooks {
    ...
    @Description("03 07 04.1.10 Ввод и редактирование данных Заявки (Сборный груз). Отправка Заявки на рассмотрение")
    @Link(name="Test_03_07_04_1_10", url="https://confluence.exportcenter.ru/pages/viewpage.action?pageId=127898286")
    ...
    public void step06() {
        ...
        new GUIFunctions()
                ...
                .inField("Населенный пункт").inputValue(PROPERTIES.getProperty("Информация о грузополучателе.Населенный пункт")).assertNoControl().assertValue()
                .inField("Район").inputValue(PROPERTIES.getProperty("Информация о грузополучателе.Район")).assertNoControl().assertValue()
                .inField("Строение").inputValue(PROPERTIES.getProperty("Информация о грузополучателе.Строение")).assertNoControl().assertValue()
                .inField("Улица").inputValue(PROPERTIES.getProperty("Информация о грузополучателе.Улица")).assertNoControl().assertValue()
                .inField("Офис").inputValue(PROPERTIES.getProperty("Информация о грузополучателе.Офис")).assertNoControl().assertValue()
