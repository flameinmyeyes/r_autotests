...
public class Test_07_07_07 extends Hooks {
    ...
    @Description("07.07.07 Выдача сертификата о происхождении товара формы СТ-1 для Республики Узбекистан")
    @Link(name = "Test_07_07_07", url = "https://confluence.exportcenter.ru/pages/viewpage.action?pageId=175264656")
