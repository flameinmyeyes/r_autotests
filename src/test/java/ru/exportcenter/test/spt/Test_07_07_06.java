...
public class Test_07_07_06 extends Hooks {

    private String WAY_TEST = Ways.TEST.getWay() + "/SPT/Test_07_07_06/";
    public String WAY_TO_PROPERTIES = WAY_TEST + "Test_07_07_06_properties.xml";
    public Properties PROPERTIES = PropertiesHandler.parseProperties(WAY_TO_PROPERTIES);
    public String requestNumber;

    @Owner(value = "Теребков Андрей")
    @Description("07.07.06 Выдача сертификата  СТ-2 (выдать на английском языке) / Общей формы (выдать на английском языке) / Формы EAV / Формы A о происхождении товара")
    @Link(name = "Test_07_07_06", url = "https://confluence.exportcenter.ru/pages/viewpage.action?pageId=175264516")
