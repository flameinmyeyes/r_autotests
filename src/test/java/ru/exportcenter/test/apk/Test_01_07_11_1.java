...
//                .uploadFile("Платежное поручение", "C:\\auto-tests\\payment 228.zip")
    ...
    public void step05() {
        ...
        new GUIFunctions().inContainer("Направление заявки на регистрацию уполномоченных лиц участника системы")
                .inField("Ввод данных (ФИО)").selectValue("Антонов\u00a0Антон\u00a0Антонович").assertValue()
                .inField("Согласование (ФИО)").selectValue("Антонов\u00a0Антон\u00a0Антонович").assertValue()
                .inField("Утверждение (ФИО)").selectValue("Антонов\u00a0Антон\u00a0Антонович").assertValue()
                .inField("Просмотр (ФИО)").selectValue("Антонов\u00a0Антон\u00a0Антонович").assertValue();
