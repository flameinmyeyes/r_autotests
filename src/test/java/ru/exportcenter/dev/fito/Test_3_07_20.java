...
public class Test_3_07_20 extends Hooks {
    ...
    public String WAY_TEST = Ways.DEV.getWay() + "/fito/Test_3_07_20/";
    public String WAY_TO_PROPERTIES = Ways.DEV.getWay() + "/fito/Test_3_07_20/" + "Test_3_07_20_properties.xml";
    ...
    @Description("3.07.20 Возможность отказаться от принятия условий проекта договора и отбора проб")
    @Link(name = "Test_3_07_20", url = "https://confluence.exportcenter.ru/pages/viewpage.action?pageId=188845363")
    ...
    public void precondition() {
        //Предусловие: выполнить шаги 1-13 из ТК https://confluence.exportcenter.ru/pages/viewpage.action?pageId=163308618
