...
import framework.FileFunctions.JSONEditor;
...
//            APIFunctions.sendRESTRequest(requestType, requestURL, requestBody, LOGIN, PASSWORD);
...
//    }
    ...
    public static void sendAttachmentToTestresult(String testcase, String testrun, File attachmentFile) {
        ...
        try {
            ...
            //отправляем REST-запрос с результатами прохождения теста
            APIFunctions.sendRESTRequest("POST", requestURL, attachmentFile, LOGIN, PASSWORD);
    ...
    public static String getTestresultFromTestrun(String testcase, String testrun) {
        ...
        try {
            ...
            String getRequestResponse = APIFunctions.sendRESTRequest("GET", getRequestURL, LOGIN, PASSWORD);
    ...
    public static void writeIncorrectTestsToFile(Class testClass, String testCase, String testStatus, String jiraUser) {
        if (testCase.equals("")) {
            String text = CommonFunctions.dateToday("yyyy-MM-dd HH:mm") + " - " + testClass + " - " + "jiraUser: " + jiraUser + " - " + "testStatus: " + testStatus + "\n";
